...
import { Button, ImagePickerModal, ImageViewer } from "~/components";
...
export default function ImagePickerScreen() {
    ...
    return (
        <>
            ...
            <ImagePickerModal isShow={isShowImagePickerModal === -111} onClose={imagePickerModalHandlers.close} uploadUri={selectedImage} />
        </>
    );
}

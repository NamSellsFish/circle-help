...
/**
 * Mandates that control of the current transaction be handled by the caller.
 *
 * By default, annotated methods requires an ongoing transaction and do not rollback for any exceptions.
 */
@Target(
...
@MustBeDocumented
@Transactional
annotation class ManagementRequiredTransaction(
    /**
     ...
     */
    @get:AliasFor(annotation = Transactional::class) val propagation: Propagation = Propagation.MANDATORY,
    /**
